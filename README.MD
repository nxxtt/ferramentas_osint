...
Código utilize as features modernas do Python 3.12+: `asyncio.TaskGroup` para concorrência segura, `match/case` para dispatch, `tomllib` para parsing TOML, `@override` para herança, e f-strings PEP 701.
