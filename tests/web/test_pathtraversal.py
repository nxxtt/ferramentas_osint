...
from mytools.web.pathtraversal import (
    _CATEGORY_MAP,
    ...
    _test_platform_traversal,
    _test_semicolon_traversal,
    build_parser,
    main,
    print_results,
    scan_path_traversal,
...
class TestCategoryMap:
    ...
    def test_all_categories_present(self) -> None:
        expected = {"path", "param", "semicolon", "mixed", "platform"}
...
class TestTestMixedTraversal:
    """Testes para _test_mixed_traversal."""
...
class TestScanPathTraversal:
    """Testes para scan_path_traversal."""

    @pytest.mark.asyncio
    async def test_invalid_category(self) -> None:
        result = await scan_path_traversal("https://example.com", category="invalid")
...
class TestPathTraversalAttempt:
    """Testes para PathTraversalAttempt dataclass."""

    def test_frozen(self) -> None:
        att = PathTraversalAttempt(
            technique="test", category="path", url="http://x.com",
            payload="..%2fetc/passwd", status_baseline=200, status_test=200,
...
class TestPathTraversalResult:
    """Testes para PathTraversalResult dataclass."""
...
class TestPrintResults:
    ...
    def test_print_vulnerable(self, capsys: pytest.CaptureFixture[str]) -> None:
        result = PathTraversalResult(
            ...
            tls=True,
            attempts=[PathTraversalAttempt(
                technique="url_encoded", category="path", url="https://example.com/test",
                payload="..%2fetc/passwd", status_baseline=200, status_test=200,
